...
const LoanMessage = () => {
  return (
    <div>
      ...
      <div className="bg-white fixed z-50 bottom-0 left-0 w-full p-1 sm:p-4 border rounded-t-2xl space-x-5 flex justify-center items-center flex-col md:flex-row md:space-x-5">
        ...
        <div className="border-2 border-green-500 rounded-3xl px-3 py-1 text-xs sm:text-lg font-medium text-green-500 flex items-center shadow-md mt-2 md:mt-0">
          ...
          <a href="https://wa.me/918109952379" className="block md:inline">
            +91 8109952379
          </a>
        </div>
      </div>
