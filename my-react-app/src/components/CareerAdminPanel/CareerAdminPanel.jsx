...
const CareerAdminPanel = () => {
  ...
  useEffect(() => {
    const fetchCareer = async () => {
      try {
        ...
        const token = await getAccessTokenSilently(); // secure token if needed
        const res = await axios.get("https://backendloanok.vercel.app/api/carrer", {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = await getAccessTokenSilently(); // optional if backend requires auth
      await axios.delete(`https://backendloanok.vercel.app/api/carrer/${id}`, {
